...
<head>
    ...
    <link rel="apple-touch-icon" href="{{ asset('../web/touch-icon-iphone.png') }}">
    <link rel="apple-touch-icon" sizes="152x152" href="{{ asset('../web/touch-icon-ipad.png') }}">
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('../web/touch-icon-iphone-retina.png') }}">
    <link rel="apple-touch-icon" sizes="167x167" href="{{ asset('../web/touch-icon-ipad-retina.png') }}">
    <!-- Vendor Styles including: Bootstrap, Font Icons, Plugins, etc.-->
    <link rel="stylesheet" media="screen" href="{{ asset('../web/css/vendor.min.css') }}">
    <!-- Main Template Styles-->
    <link id="mainStyles" rel="stylesheet" media="screen" href="{{ asset('../web/css/styles.min.css') }}">
    <!-- Customizer Styles-->
    <link rel="stylesheet" media="screen" href="{{ asset('../web/customizer/customizer.min.css') }}">
    <!-- Google Tag Manager-->
    <script>
...
<header>
    ...
    <div class="customizer">
        ...
        <div class="customizer-body">
            ...
            </div><a class="btn btn-primary btn-rounded btn-block margin-bottom-none" href="../../../../wrapbootstrap.com/theme/unishop-universal-e-commerce-template-WB0148688/index4914.html?ref=rokaux">Buy Unishop</a>
        </div>
    </div>
    ...
    <div class="topbar">
        ...
        <div class="topbar-column"><a class="hidden-md-down" href="#"><i class="icon-download"></i>&nbsp; Get mobile app</a>
            <div class="lang-currency-switcher-wrap">
                <div class="lang-currency-switcher dropdown-toggle"><span class="language"><img alt="English" src="{{ asset('../web/img/flags/GB.png') }}"></span><span class="currency">$ USD</span></div>
                <div class="dropdown-menu">
                    ...
                    </div><a class="dropdown-item" href="#"><img src="{{ asset('../web/img/flags/FR.png') }}" alt="Français">Français</a><a class="dropdown-item" href="#"><img src="i{{ asset('../web/img/flags/DE.png') }}" alt="Deutsch">Deutsch</a><a class="dropdown-item" href="#"><img src="{{ asset('../web/img/flags/IT.png') }}" alt="Italiano">Italiano</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <header class="navbar navbar-sticky">
        ...
        <div class="site-branding">
            <div class="inner">
                ...
                <!-- Site Logo--><a class="site-logo" href="index.html"><img src="{{ asset('../web/img/logo/logotn.png') }}" alt="Unishop"></a>
            </div>
        </div>
        <!-- Main Navigation-->
        <nav class="site-menu">
            ...
            <ul>
                ...
                <li class="has-megamenu"><a href="" ><span>Acualité</span></a>
...
<footer>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-7 padding-bottom-1x">
                    <!-- Payment Methods-->
                    <div class="margin-bottom-1x" style="max-width: 615px;"><img src="{{ asset('../web/img/payment_methods.png') }}" alt="Payment Methods">
            ...
            <!-- Copyright-->
            <p class="footer-copyright">© All rights reserved. Hacked with &nbsp;<i class="icon-heart text-danger"></i><a href="../../../../rokaux.com/index.html" target="_blank"> &nbsp;By Yassine Ben Gharsallah</a></p>
        </div>
    </footer>
    </div>
    ...
    <!-- Customizer scripts-->
    <script src="{ asset('../web/customizer/customizer.min.js') }}"></script>
